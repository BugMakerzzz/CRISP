...
# config是一些具体参数设置，一般网站教程会说，主要就是URL和APIKEY
            ...
            if not queue_of_requests_to_retry.empty():
                ...
                try:
                    ...
                    if model.startswith('o1'):
                        ...
                        request_json = {"model":model, "messages":next(requests), "logprobs":logprobs, "top_logprobs":top_logprobs, "max_tokens":max_tokens, "temperature":temperature, "n":sample_cnt}
...
# requests 格式：一个二维list，其中每个list的内容如下，每个list相当于一个任务：
# [{"role": "system", "content": 全局指令内容，一般包含工作目标和输出格式}, {"role": "user", "content": 你的query}]
# return 格式：通过以下获取第0个任务对应的model回复
